...
This document defines the core domain entities, attributes, and relationships for the Wander application, serving as the canonical business domain reference for both the backend (`tripsapi`) and frontend (`tripsui`).
